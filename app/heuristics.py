class Heuristics:
	...
	# Find the next shortest operations
	@staticmethod
	def find_next_shortest_operations(jobs_to_be_done, max_operations):
		best_candidates = {}
	...
	# LEPT rule
	@staticmethod
	def longest_expected_processing_time_first(jobs_to_done, max_operations):
		pass
